...
echo "<link rel='stylesheet' href='/style.css?v=13'></head><body><div class='wrap'><div class='card'><div class='err-icon'>⚠️</div><h1>Etwas ist schiefgelaufen</h1>";
    ...
    echo "</div></div><footer>© 2026 KündigungExpress · <a href='/impressum.html'>Impressum</a> · <a href='/datenschutz.html'>Datenschutz</a></footer><style>
...
// Lăsăm $plateLine gol pentru a fi eliminat curat din HTML (compatibilitate)
$plateLine = '';
